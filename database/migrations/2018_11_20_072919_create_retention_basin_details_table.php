...
class CreateRetentionBasinDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('retention_basin_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('retention_basin_details');
    }
}
