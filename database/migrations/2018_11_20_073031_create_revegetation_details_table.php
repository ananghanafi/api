...
class CreateRevegetationDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('revegetation_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('revegetation_details');
    }
}
