...
class CreateRevitalizationPlansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('revitalization_plans', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('revitalization_plans');
    }
}
