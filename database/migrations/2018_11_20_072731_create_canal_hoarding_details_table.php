...
class CreateCanalHoardingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('canal_hoarding_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('canal_hoarding_details');
    }
}
