...
class CreateRevitalizationDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('revitalization_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('revitalization_details');
    }
}
