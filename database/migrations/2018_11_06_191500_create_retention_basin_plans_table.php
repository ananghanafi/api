...
class CreateRetentionBasinPlansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('retention_basin_plans', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('retention_basin_plans');
    }
}
