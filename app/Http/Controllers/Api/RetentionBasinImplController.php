...
use App\Models\RetentionBasinDetail;
use App\Models\ImplProgress;
use Validator;

class RetentionBasinImplController extends Controller
{
    use ControllerTrait;
    ...
    public function document($id,Request $request) {
        ...
        $impl = RetentionBasinImpl::find($id);
    ...
    public function update($id,Request $request) {
        ...
        $modelDetail = new RetentionBasinDetail;
        $request->id = $id;
    ...
    public function implProgress($id, Request $request) {
        ...
        $new = $model->add($request,'App\Models\RetentionBasinImpl');
    ...
    public function show($id) {
        ...
        $detailActivity = $exist->retentionBasinDetail()->first();
